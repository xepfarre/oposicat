      ...
      <main className="w-full max-w-md px-6 flex flex-col gap-6">
        {fetsRellevants.map((fet, index) => (
          <motion.div
            ...
            className="relative bg-white/5 border border-white/10 rounded-[2.5rem] p-6 pt-8 shadow-xl"
          >
            {/* Etiqueta de mes flotant */}
            <div className="absolute -top-3 left-8 bg-emerald-500 text-[#00274d] px-4 py-1.5 rounded-full font-black italic uppercase text-[10px] tracking-widest shadow-lg shadow-emerald-500/20">
              {fet.mes}
            </div>

            <div className="flex flex-col gap-3">
              <div className="flex items-start justify-between gap-4">
                <h2 className="text-white font-black italic uppercase tracking-tight text-sm leading-tight pr-4">
                  {fet.titol}
                </h2>
                <div className="shrink-0 flex flex-col items-end gap-1">
                   ...
                   <span className="text-[8px] font-black uppercase tracking-[0.1em] opacity-30 italic">Impacte</span>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2 mt-1 py-2 px-3 bg-white/5 rounded-2xl w-fit">
                ...
                <span className="text-[9px] font-bold uppercase tracking-widest text-emerald-400/80">Confirmat per ISPC</span>
              </div>
            </div>
          </motion.div>
        ))}

        <div className="mt-8 bg-white/5 border border-white/10 rounded-[2rem] p-8 flex flex-col items-center gap-4 text-center">
