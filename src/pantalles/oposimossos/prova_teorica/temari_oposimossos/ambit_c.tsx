...
export default function AmbitC({ 
  onTornar, 
  temes, 
  progres, 
  progresDetallat,
    ...
    <div className="flex min-h-screen w-full flex-col items-center pb-12 px-6 bg-[#00274d] overflow-y-auto">
      <header className="pt-10 w-full max-w-sm md:max-w-2xl flex items-center gap-4 mb-8">
        ...
        <div className="flex-1">
          <span className="text-emerald-400 font-black italic uppercase text-[10px] tracking-widest block mb-1">Àmbit C</span>
      ...
      <footer className="mt-12 text-center text-white/20">
        <p className="text-[10px] font-black uppercase tracking-[0.2em]">OposiCatalunya • Ambit C • Resums</p>
      </footer>
    </div>
  );
}
