...
export default function AmbitB({ 
  onTornar, 
  temes, 
  progres, 
  progresDetallat,
  ...
  return (
    ...
    >
      ...
      >
        <div className="w-full md:max-w-4xl mx-auto flex items-center gap-4">
          ...
          <div className="flex-1">
            <span className={`text-amber-400 font-black italic uppercase tracking-widest block ${
      ...
      <footer className="mt-12 text-center text-white/20">
        <p className="text-[10px] font-black uppercase tracking-[0.2em]">OposiCatalunya • Ambit B • Resums</p>
      </footer>
    </div>
  );
}
